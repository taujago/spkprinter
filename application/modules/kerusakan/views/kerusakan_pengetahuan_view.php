<h4>DATA PENGETAHUAN PER KERUSAKAN</h4>
<div class="table-responsive">
	...
	<thead>
		<tr>
			...
			<TH rowspan="2"><strong>KERUSAKAN</strong></strong> </TH>
...
<div class="table-responsive">
	...
	<thead>
		<tr>
			...
			<th align="center" colspan="<?php echo $rec_kerusakan->num_rows(); ?>" ><strong>KERUSAKAN</strong></strong></th>
		</tr>
		<tr>
			<?php foreach($rec_gejala->result() as $kol) : ?>
				<th><strong><?php echo $kol->kode; ?></strong></th>
